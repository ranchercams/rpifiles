...
sed -i -e 's/,.*//' -e '/^$/ d' /home/pi/rpifiles/vedirect/sig.py
sleep 1
...
sleep 1
cat /home/pi/rpifiles/vedirect/bars.txt /home/pi/rpifiles/vedirect/power.txt /home/pi/rpifiles/vedirect/op.txt > /home/pi/rpifiles/RPI_SSD1306/sigpower.py
sleep 1
