...
font2 = ImageFont.truetype('fontawesome-webfont2.ttf', 32)
font3 = ImageFont.truetype('Montserrat-Medium.ttf', 12)
font_icon_big = ImageFont.truetype('fontawesome-webfont2.ttf', 40)
...
def Battery_icon_and_percentage (value):
    if value<10:
        ...
        draw.text((x+45, top+17),       unichr(62019),  font=font2, fill=255)
    elif value<12:
        draw.text((x+45, top+17),       unichr(62018),  font=font2, fill=255)
    elif value<13:
        draw.text((x+45, top+17),       unichr(62017),  font=font2, fill=255)
    else:
        draw.text((x+40, top+17),       unichr(62016),  font=font2, fill=255)
    draw.text((x+35 , top),      "Battery",  font=font, fill=255)
    draw.text((x+48, top+46),      str(value),  font=font_text_big, fill=255)
...
def Bars_icon (value, var_opp):
    if value==1:
        draw.text((x+45, top+20),       unichr(63116),  font=font2, fill=255)
    elif value==2:
        draw.text((x+45, top+20),       unichr(63117),  font=font2, fill=255)
    elif value==3:
        draw.text((x+45, top+20),       unichr(63118),  font=font2, fill=255)
    elif value==4:
        draw.text((x+45, top+20),       unichr(63119),  font=font2, fill=255)
    elif value==5:
        draw.text((x+45, top+20),       unichr(61458),  font=font2, fill=255)
    else:
