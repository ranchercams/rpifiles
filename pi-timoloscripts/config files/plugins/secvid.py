...
imageNamePrefix = "vid-" + str(custnumber)       # default= 'vid-' for all image file names. Eg garage-
...
imageWidth = 1296              # default= 1280 Full Size Image Width in px
imageHeight = 972              # default= 720  Full Size Image Height in px
...
motionVideoFPS = 2            # default= 25 If image size reduced to 640x480 then slow motion is possible at 90 fps
...
#---------------------------
spaceTimerHrs = 12           # default= 0  0=off or specify hours frequency to perform free disk space check
