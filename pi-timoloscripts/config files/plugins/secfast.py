...
imageNamePrefix = "fast-" + str(custnumber)      # default= 'fast-' for all image file names. Eg garage-
...
#---------------------------
spaceTimerHrs = 12              # default= 1  0=off or specify hours frequency to perform free disk space check
