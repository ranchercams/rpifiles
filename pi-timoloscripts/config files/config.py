...
pluginName = "secvid"     # Specify filename in plugins subfolder without .py extension per below
...
# Image Settings
# --------------
imageNamePrefix = str(custnumber)  # default= 'cam1-' for all image file names. Eg garage-
imageWidth = 1296          # default= 1024 Full Size Image Width in px
imageHeight = 972          # default= 768  Full Size Image Height in px
...
useVideoPort = True       # default= False True=Use the video port to capture motion images (faster than the image port).
imageShowStream = True    # default= False True=Show video stream motion tracking area on full size image.
...
web_page_title = "RancherCam Media"  # web page title that browser shows
