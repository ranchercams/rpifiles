...
def retry_and_stop_after_1_mins():
	...
	os.system("bash /home/pi/rpifiles/RancherCamScripts/upload.sh")
        ...
        logging.critical('Upload-Retry.py - Internet is STILL down, rebooting system and scheduling upload attempt 5 mins from now ...')
	pass
...
def check_internet():
	...
	os.system("bash /home/pi/rpifiles/RancherCamScripts/upload.sh")
        ...
        logging.warning('Upload-Retry.py - Internet is still down, Resetting Modem...')
